    ...
    <div className="min-h-screen bg-void text-on-background">
      ...
      <aside className="fixed left-0 top-20 h-[calc(100vh-80px)] w-64 bg-black border-r-4 border-neutral-900 flex flex-col py-4 overflow-y-auto z-40">
        ...
        <nav className="flex flex-col gap-1">
          ...
          <SidebarItem icon={Boxes} label="INVENTORY" href="/inventory" />
          <SidebarItem icon={ReceiptText} label="NEW SALE" href="/pos" />
      ...
      <main className="ml-64 mt-20 p-6 grid grid-cols-12 gap-6 pb-24">
        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <QuickActionButton icon={PlusCircle} label="NEW_SALE" color="#FF007F" bgColor="#3f001a" iconFill href="/pos" />
            <QuickActionButton icon={PackagePlus} label="ADD_PRODUCT" color="#00FFFF" bgColor="black" href="/inventory" />
